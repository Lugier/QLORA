...
def export_model():
    ...
    if not os.path.exists(model_path):
        print(f"CRITICAL ERROR: Trainiertes Modelverzeichnis '{model_path}' nicht gefunden.")
        print("Sicherstellen, dass phase2_grpo.py erfolgreich ausgeführt wurde.")
        return
    ...
    try:
        ...
        print(f"[-] HuggingFace 16-bit Merge Failed: {e}")
